...
const CENTERS: Center[] = [
  ...
  { code: 'RTP10', name: 'PFSC10', nameTH: 'ศพฐ.10', targetCases: 290091 },
]
...
// NDDB Data for ศพฐ.10 (ข้อมูลจริงตั้งแต่ 2008)
...
// Total expected for ศพฐ.10: 290,091 cases (2008-2025)
const TOTAL_RTP10 = NDDB_YEARLY_DATA.reduce((sum, y) => sum + y.count, 0)
